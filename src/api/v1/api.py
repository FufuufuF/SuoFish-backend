...
from src.api.v1.endpoints.get_conversations import router as get_conversations_router
...
router.include_router(get_conversations_router, prefix="/conversations")
